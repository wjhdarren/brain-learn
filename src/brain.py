    ...
    if simulation_response.status_code == 201:
        ...
        while not finished and total_wait_time < timeout:
            ...
            if total_wait_time >= timeout:
                print(f"Timeout of {timeout} seconds will be exceeded. Aborting.")
                return None
        ...
        if finished:
            ...
            print(f"Simulation timed out after {total_wait_time} seconds")
            return None
    else:
        print("Failed to send simulation. Status code:", simulation_response.status_code)
        print("Response:", simulation_response.text)
        return None
